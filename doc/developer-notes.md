...
However, in open source software such as Owncoin Core, where everyone uses
...
pay attention to for reviewers of Owncoin Core code.

General Owncoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Owncoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
...
be sent upstream but bugfixes may also be prudent to PR against Owncoin Core so that they can be integrated
