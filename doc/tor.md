TOR SUPPORT IN OWNCOIN CORE
=======================

It is possible to run Owncoin Core as a Tor hidden service, and connect to such services.
...
1. Run Owncoin Core behind a Tor proxy
----------------------------------

The first step is running Owncoin Core behind a Tor proxy. This will already make all
...
2. Run a Owncoin Core hidden server
-------------------------------
...
your dashd's P2P listen port (9999 by default).
	...
	-externalip=X   You can tell Owncoin Core about its publicly reachable address using
...
3. List of known Owncoin Core Tor relays
------------------------------------
...
Owncoin Core has been updated to make use of this.

This means that if Tor is running (and proper authentication has been configured),
Owncoin Core automatically creates a hidden service to listen on. This will positively 
affect the number of available .onion nodes.

This new feature is enabled by default if Owncoin Core is listening (`-listen`), and
