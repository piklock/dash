...
* Update translations, see [translation_process.md](https://github.com/piklock/owncoin/blob/master/doc/translation_process.md#synchronising-translations).

* Update manpages, see [gen-manpages.sh](https://github.com/piklock/owncoin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
* Update hardcoded [seeds](/contrib/seeds/README.md). TODO: Give example PR for Owncoin
...
Check out the source code in the following directory hierarchy.
	...
	git clone https://github.com/piklock/owncoin.git
...
- Detached signatures will then be committed to the [dash-detached-sigs](https://github.com/piklock/owncoin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Release on Owncoin forum: https://www.dash.org/forum/topic/official-announcements.54/

  - Optionally Discord, twitter, reddit /r/Piklock, ... but this will usually sort out itself

  - Notify flare so that he can start building [the PPAs](https://launchpad.net/~dash.org/+archive/ubuntu/dash)

  - Archive release notes for the new version to `doc/release-notes/` (branch `master` and branch of the release)

  - Create a [new GitHub release](https://github.com/piklock/owncoin/releases/new) with a link to the archived release notes.
