...
We outline an initial scaling mechanism for Owncoin. After deployment and activation, Owncoin will be able to handle double the transactions it can currently handle. Together with the faster block times, Owncoin we will be prepared to handle eight times the traffic of Bitcoin.
...
All transaction fees are reduced 10x (from 10K per Kb to 1K per Kb), including fees for InstantSend (from 0.001 OWNCOIN per input to 0.0001 per input)
...
- [`b0843c397`](https://github.com/dashpay/dash/commit/b0843c397) Backport Bincoin PR#7348: MOVE ONLY: move rpc* to rpc/ + same for Owncoin-specific rpc (#1502)
...
- [`b9c67258b`](https://github.com/dashpay/dash/commit/b9c67258b) Backport Bitcoin PR#9609: net: fix remaining net assertions (#1575) + Owncoinify
...
- [`753b1e486`](https://github.com/dashpay/dash/commit/753b1e486) Eliminate remaining uses of g_connman in Owncoin-specific code. (#1635)
...
- [`7ab175a8e`](https://github.com/dashpay/dash/commit/7ab175a8e) Ensure Owncoin wallets < 0.12.2 can't open HD wallets (#1638)
...
- [`715504357`](https://github.com/dashpay/dash/commit/715504357) Owncoinify bitcoin unix executables (#1486)
