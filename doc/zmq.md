...
The Owncoin Core daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in Owncoin Core requires ZeroMQ API version 4.x or
...
using. Owncoind appends an up-counting sequence number to each
