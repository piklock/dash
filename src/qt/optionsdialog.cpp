    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("OWNCOIN-light"), QVariant("light"));
    ui->theme->addItem(QString("OWNCOIN-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("OWNCOIN-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("OWNCOIN-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("OWNCOIN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("OWNCOIN-Crownium"), QVariant("crownium"));
