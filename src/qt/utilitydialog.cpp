...
All the Owncoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 OWNCOIN, 0.1 OWNCOIN, 1 OWNCOIN and 10 OWNCOIN -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://piklock.atlassian.net/wiki/display/DOC/PrivateSend\">https://piklock.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
