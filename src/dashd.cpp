 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called Owncoin (https://www.dash.org/),
...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        {
#if HAVE_DECL_DAEMON
            fprintf(stdout, "Owncoin Core server starting\n");
